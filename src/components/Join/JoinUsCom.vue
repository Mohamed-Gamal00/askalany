...
<style scoped>
.form-control[data-v-33d61464],
.form-select[data-v-33d61464] {
...
.form-select:focus {
  ...
  border-color: #f48928 !important;
  outline: 0;
  box-shadow: 0 0 0 0.25rem #ff861857 !important;
}
.form-control,
.form-select {
  border-radius: 20px;
